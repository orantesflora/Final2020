...
```{r}  
DataGBTQ = filter(TrialData,LGBTQ=="gay")
barchartGC(~infected + treatment, data= DataGBTQ)
barchartGC(~infected + treatment, data=DataGBTQ,type="percent",main="gays")  

```
  
##Graphical Description Results  

```{r}
DataDrugUser = filter(TrialData,DrugUser=="users")
barchartGC(~infected + treatment, data= DataDrugUser)
barchartGC(~infected + treatment, data=DataDrugUser, type="percent",main="user")  

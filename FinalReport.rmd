...
Every question is og CAT ~CAT type
...
DataF = filter(TrialData,sex=="F")
barchartGC(~infected + treatment,data=TrialData, type="percent")

```

Among females that contracted Aids twice as many took the placebo. Therefore it appears that the vaccine does have an effect.
